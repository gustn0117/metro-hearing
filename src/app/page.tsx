  ...
  return (
    <>
      ...
      <section className="relative h-screen min-h-[600px] max-h-[960px] flex items-center overflow-hidden mt-[var(--header-h)]">
        ...
        <FadeUp className="relative z-10 text-white max-w-[760px] px-8 lg:pl-20">
          <span className="inline-flex items-center text-xs font-bold tracking-[.2em] uppercase text-white/90 mb-6 border-l-[3px] border-[var(--color-gold)] pl-4" style={{ letterSpacing: ".2em" }}>
            Hearing Care Specialist
          </span>
          <h1
            className="text-6xl max-lg:text-[42px] max-md:text-[30px] font-extrabold leading-[1.1] mb-6"
            style={{ textShadow: "0 4px 24px rgba(0,0,0,.35), 0 1px 4px rgba(0,0,0,.2)", letterSpacing: "-0.02em" }}
          >
            정확한 진단이<br />올바른 선택을 만듭니다
          </h1>
          <p className="text-xl max-md:text-base text-white/85 mb-12 leading-relaxed max-w-[500px]" style={{ letterSpacing: "-0.01em" }}>
            청능사·청각사가 직접 상담하는<br />청각 전문 솔루션 센터
          </p>
          <div className="flex items-center gap-4 max-md:flex-col max-md:items-start">
            <a href="tel:1800-9665" className="inline-flex items-center gap-2.5 px-10 py-4.5 bg-[var(--color-gold)] text-white text-base font-bold rounded-sm hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(212,168,83,.4)] transition-all duration-300 shadow-lg">
            ...
            <Link href="/center#location" className="inline-flex items-center gap-2 px-7 py-4 border-2 border-white/40 text-white rounded-sm font-semibold hover:bg-white/10 hover:border-white/70 transition-all duration-300">
              오시는 길
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          <div className="grid grid-cols-4 max-md:grid-cols-2 gap-4 max-md:gap-3">
            {[
              ...
              <FadeUp key={i}>
                <div className="relative bg-white rounded-none p-6 max-md:p-4 text-center shadow-[0_2px_16px_rgba(0,0,0,.08)] hover:shadow-[0_8px_30px_rgba(0,0,0,.12)] hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                  {/* Top accent border */}
                  <div className="absolute top-0 left-0 right-0 h-[3px] bg-[var(--color-primary)]" />
                  <div className="w-12 h-12 mx-auto mb-3 rounded-none bg-[var(--color-primary-light)] flex items-center justify-center">
                    {stat.icon}
                  </div>
      ...
      <section className="py-28 max-md:py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          <FadeUp>
            <span className="inline-flex items-center text-xs font-bold tracking-[.15em] uppercase text-[var(--color-primary)] mb-4 border-l-[3px] border-[var(--color-primary)] pl-3">
              Core Services
            </span>
            <h2 className="text-5xl max-md:text-[26px] font-extrabold leading-tight mb-3" style={{ letterSpacing: "-0.02em" }}>
              4대 <span className="gradient-text">핵심 서비스</span>
            </h2>
            <div className="section-divider mb-4" />
            <p className="text-[17px] text-gray-500 max-w-[650px] mb-16 leading-relaxed">메트로 보청기는 상담부터 사후관리까지 체계적인 서비스를 제공합니다.</p>
          </FadeUp>
          <ServicesSlider />
        </div>
      </section>
      ...
      {/* ── Why Metro / Strengths ── */}
      <section className="py-28 max-md:py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <FadeUp>
            <span className="inline-flex items-center text-xs font-bold tracking-[.15em] uppercase text-[var(--color-primary)] mb-4 border-l-[3px] border-[var(--color-primary)] pl-3">
              Why Metro
            </span>
            <h2 className="text-5xl max-md:text-[26px] font-extrabold mb-3" style={{ letterSpacing: "-0.02em" }}>
              잘 들리는 <span className="gradient-text">메트로보청기</span>
            </h2>
            <div className="section-divider mx-auto mb-4" />
            <p className="text-[17px] text-gray-500 max-w-[650px] mx-auto mb-16">메트로 보청기만의 차별화된 서비스로 고객 만족을 실현합니다.</p>
          </FadeUp>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 stagger-children">
            {[
              ...
              <FadeUp key={i}>
                <div className="relative bg-white rounded-none shadow-[0_2px_16px_rgba(0,0,0,.06)] hover:shadow-[0_12px_40px_rgba(0,0,0,.1)] hover:-translate-y-2 transition-all duration-400 p-10 text-center group overflow-hidden border border-gray-100">
                  {/* Top accent bar */}
                  <div className={`absolute top-0 left-0 right-0 h-[3px] ${s.barColor} opacity-70 group-hover:opacity-100 transition-opacity`} />
                  <div className={`w-16 h-16 mx-auto mb-6 rounded-none bg-gradient-to-br ${s.color} flex items-center justify-center shadow-lg`}>
                    {s.icon}
                  </div>
                  <h3 className="text-xl font-bold mb-3" style={{ letterSpacing: "-0.01em" }}>{s.title}</h3>
      ...
      {/* ── Global Brands ── */}
      <section className="py-28 max-md:py-20 bg-[#0f172a] relative overflow-hidden">
        <div className="absolute inset-0">
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10 text-center">
          <FadeUp>
            <span className="inline-flex items-center gap-2 text-xs font-bold tracking-[.15em] uppercase text-white/90 mb-6 border-l-[3px] border-[var(--color-gold)] pl-4">
            ...
            <h2 className="text-5xl max-md:text-[26px] font-extrabold text-white mb-4" style={{ letterSpacing: "-0.02em" }}>
              글로벌 보청기 <span className="text-[var(--color-gold)]">비교 전문센터</span>
            </h2>
            <p className="text-[17px] text-white/70 max-w-[700px] mx-auto mb-16 leading-relaxed">
          ...
          <div className="flex justify-center items-center gap-6 max-lg:gap-4 flex-wrap stagger-children">
            {[
              ...
              <FadeUp key={b.id}>
                <Link href={`/brands#${b.id}`} className="group flex flex-col items-center gap-3 px-8 py-6 max-md:px-5 max-md:py-4 rounded-none bg-white/[0.04] border border-white/10 hover:bg-white/[0.1] hover:border-white/25 hover:-translate-y-1 transition-all duration-300">
      ...
      {/* ── CTA Section ── */}
      <section className="relative py-28 max-md:py-16 overflow-hidden">
        <div className="absolute inset-0">
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10">
          <div className="flex max-lg:flex-col items-center gap-16">
            <FadeUp className="flex-1 text-white">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-none bg-[var(--color-gold)]/20 border border-[var(--color-gold)]/40 text-[var(--color-gold)] text-sm font-semibold mb-6 float-anim">
              ...
              <h2
                className="text-[40px] max-md:text-2xl font-extrabold mb-3 leading-tight"
                style={{ textShadow: "0 2px 12px rgba(0,0,0,.2)", letterSpacing: "-0.02em" }}
              >
                지금 바로<br />상담하세요
              </h2>
              ...
              <ul className="space-y-4 mb-10">
                {["정확한 청력검사", "보청기 비교 체험 예약", "정부지원 가능 여부 확인"].map((t) => (
                  <li key={t} className="flex items-center gap-3 text-lg">
                    <span className="flex-shrink-0 w-6 h-6 rounded-none bg-[var(--color-gold)]/20 flex items-center justify-center">
              ...
              <div className="flex gap-4 max-md:flex-col">
                <a href="tel:1800-9665" className="inline-flex items-center gap-2.5 px-8 py-4 bg-[var(--color-gold)] text-white rounded-sm font-bold hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(212,168,83,.4)] transition-all duration-300 shadow-lg text-base">
                  <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                  전화 상담
                </a>
                <Link href="/center#location" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-white/40 text-white rounded-sm font-semibold hover:bg-white/10 hover:border-white/70 transition-all duration-300">
                  오시는 길 안내
                  <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                </Link>
              </div>
            ...
            <FadeUp className="flex-1 w-full">
              <div className="rounded-none overflow-hidden shadow-2xl border border-white/10">
